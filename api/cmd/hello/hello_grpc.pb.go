...
const (
	...
	Greeter_SayRepeatHello_FullMethodName = "/hello.Greeter/SayRepeatHello"
)
...
func (c *greeterClient) SayRepeatHello(ctx context.Context, in *RepeatHelloRequest, opts ...grpc.CallOption) (Greeter_SayRepeatHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], Greeter_SayRepeatHello_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
